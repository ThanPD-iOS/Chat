...
extension ChatView {
    ...
    nonisolated static func mapMessages(_ messages: [ChatMessage], chatType: ChatType, replyMode: ReplyMode) -> [MessagesSection] {
    ...
    nonisolated static func mapMessagesQuoteModeReplies(_ messages: [ChatMessage], chatType: ChatType, replyMode: ReplyMode) -> [MessagesSection] {
    ...
    nonisolated static func mapMessagesCommentModeReplies(_ messages: [ChatMessage], chatType: ChatType, replyMode: ReplyMode) -> [MessagesSection] {
        ...
        for date in dates {
            ...
            var dayMessages = [ChatMessage]() // insert second level in between first level
    ...
    nonisolated static private func getRepliesFor(id: String, messages: [ChatMessage]) -> [ChatMessage] {
    ...
    nonisolated static private func wrapSectionMessages(_ messages: [ChatMessage], chatType: ChatType, replyMode: ReplyMode, isFirstSection: Bool, isLastSection: Bool) -> [MessageRow] {
        messages
            .enumerated()
            .map {
                let index = $0.offset
